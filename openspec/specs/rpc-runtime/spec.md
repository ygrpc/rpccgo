# Capability: rpc-runtime

## Purpose
Provide runtime primitives that generated CGO code can depend on, including a global error message registry with TTL and a stable C ABI to retrieve error messages.
