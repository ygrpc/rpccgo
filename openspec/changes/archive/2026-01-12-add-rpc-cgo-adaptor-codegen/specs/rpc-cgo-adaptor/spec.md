# Capability: rpc-cgo-adaptor

## Purpose
Generate Go adaptor code that allows CGO-side Go code to invoke RPC service implementations by looking up handlers in the global `rpc-dispatch` registry.
