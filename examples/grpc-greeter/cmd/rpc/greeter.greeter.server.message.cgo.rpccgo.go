...
func (a *greeterCGOMessageAdapter) SayHello(ctx context.Context, req *v1.SayHelloRequest) (*v1.SayHelloResponse, error) {
	if a == nil {
...
func decodeGreeterSayHelloCGOMessageResponse(responsePtr C.uintptr_t, responseLen C.int32_t) (*v1.SayHelloResponse, error) {
...
func (a *greeterCGOMessageAdapter) StartCollect(ctx context.Context) (rpcruntime.ClientStreamingClient[*v1.SayHelloRequest, *v1.SayHelloResponse], error) {
	if a == nil {
		return nil, greeterCGOMessageServerCallbacksNil
	}
...
func (a *greeterCGOMessageAdapter) Collect(ctx context.Context, stream rpcruntime.ClientStreamingServer[*v1.SayHelloRequest]) (*v1.SayHelloResponse, error) {
...
func (s *greeterCollectCGOMessageClientStreamingClient) Send(ctx context.Context, req *v1.SayHelloRequest) error {
	if req == nil {
		err := errors.New("rpccgo: message request is nil")
		return err
	}
...
func (s *greeterCollectCGOMessageClientStreamingClient) Finish(ctx context.Context) (*v1.SayHelloResponse, error) {
	var responsePtr C.uintptr_t
	var responseLen C.int32_t
...
func decodeGreeterCollectCGOMessageResponse(responsePtr C.uintptr_t, responseLen C.int32_t) (*v1.SayHelloResponse, error) {
	resp := &v1.SayHelloResponse{}
	if responseLen < 0 {
		return nil, errors.New("rpccgo: message server response length is negative")
	}
...
func (a *greeterCGOMessageAdapter) StartBroadcast(ctx context.Context, req *v1.SayHelloRequest) (rpcruntime.ServerStreamingClient[*v1.SayHelloResponse], error) {
	if a == nil {
		return nil, greeterCGOMessageServerCallbacksNil
	}
...
func (a *greeterCGOMessageAdapter) Broadcast(ctx context.Context, req *v1.SayHelloRequest, stream rpcruntime.ServerStreamingServer[*v1.SayHelloResponse]) error {
	session, err := a.StartBroadcast(ctx, req)
	if err != nil {
		return err
	}
	for {
		resp, err, stopped := greeterAwaitCGOMessageRecv(ctx, stream.FinishRequested(), func() (*v1.SayHelloResponse, error) { return session.Recv(ctx) }, func() error { return session.Finish(ctx) }, func() error { return session.Cancel(ctx) })
		if stopped {
			return err
		}
		if err != nil {
...
func (s *greeterBroadcastCGOMessageServerStreamingClient) Recv(ctx context.Context) (*v1.SayHelloResponse, error) {
	var responsePtr C.uintptr_t
	var responseLen C.int32_t
...
func decodeGreeterBroadcastCGOMessageResponse(responsePtr C.uintptr_t, responseLen C.int32_t) (*v1.SayHelloResponse, error) {
	resp := &v1.SayHelloResponse{}
	if responseLen < 0 {
		return nil, errors.New("rpccgo: message server response length is negative")
	}
...
func (a *greeterCGOMessageAdapter) StartChat(ctx context.Context) (rpcruntime.BidiStreamingClient[*v1.SayHelloRequest, *v1.SayHelloResponse], error) {
	if a == nil {
		return nil, greeterCGOMessageServerCallbacksNil
	}
...
func (a *greeterCGOMessageAdapter) Chat(ctx context.Context, stream rpcruntime.BidiStreamingServer[*v1.SayHelloRequest, *v1.SayHelloResponse]) error {
	...
	go func() {
		for {
			resp, err, stopped := greeterAwaitCGOMessageRecv(bridgeCtx, stream.FinishRequested(), func() (*v1.SayHelloResponse, error) { return session.Recv(bridgeCtx) }, func() error { return session.Finish(bridgeCtx) }, cancelSession)
			if stopped {
				errs <- err
				return
			}
...
func (s *greeterChatCGOMessageBidiStreamingClient) Send(ctx context.Context, req *v1.SayHelloRequest) error {
	if req == nil {
		err := errors.New("rpccgo: message request is nil")
		return err
	}
...
func (s *greeterChatCGOMessageBidiStreamingClient) Recv(ctx context.Context) (*v1.SayHelloResponse, error) {
	var responsePtr C.uintptr_t
	var responseLen C.int32_t
...
func decodeGreeterChatCGOMessageResponse(responsePtr C.uintptr_t, responseLen C.int32_t) (*v1.SayHelloResponse, error) {
	resp := &v1.SayHelloResponse{}
	if responseLen < 0 {
		return nil, errors.New("rpccgo: message server response length is negative")
	}
...
func rpccgo_msg_greeterv1_Greeter_register(sayHelloCallback C.GreeterSayHelloCGOMessageUnaryCallback, collectStart C.GreeterCollectCGOMessageClientStreamStartCallback, collectSend C.GreeterCollectCGOMessageClientStreamSendCallback, collectFinish C.GreeterCollectCGOMessageClientStreamFinishCallback, collectCancel C.GreeterCollectCGOMessageClientStreamCancelCallback, broadcastStart C.GreeterBroadcastCGOMessageServerStreamStartCallback, broadcastRecv C.GreeterBroadcastCGOMessageServerStreamRecvCallback, broadcastFinish C.GreeterBroadcastCGOMessageServerStreamFinishCallback, broadcastCancel C.GreeterBroadcastCGOMessageServerStreamCancelCallback, chatStart C.GreeterChatCGOMessageBidiStreamStartCallback, chatSend C.GreeterChatCGOMessageBidiStreamSendCallback, chatRecv C.GreeterChatCGOMessageBidiStreamRecvCallback, chatCloseSend C.GreeterChatCGOMessageBidiStreamCloseSendCallback, chatFinish C.GreeterChatCGOMessageBidiStreamFinishCallback, chatCancel C.GreeterChatCGOMessageBidiStreamCancelCallback) C.int32_t {
	...
	if collectStart == nil && collectSend == nil && collectFinish == nil && collectCancel == nil {
		...
		registerErr = errors.Join(registerErr, fmt.Errorf("%w: %s", greeterCGOMessageServerStreamPartiallyRegistered, "examples.grpc.greeter.v1.Greeter.Collect"))
	}
	if broadcastStart == nil && broadcastRecv == nil && broadcastFinish == nil && broadcastCancel == nil {
		...
		registerErr = errors.Join(registerErr, fmt.Errorf("%w: %s", greeterCGOMessageServerStreamPartiallyRegistered, "examples.grpc.greeter.v1.Greeter.Broadcast"))
	}
	if chatStart == nil && chatSend == nil && chatRecv == nil && chatCloseSend == nil && chatFinish == nil && chatCancel == nil {
		...
		next.ChatFinish = nil
		next.ChatCancel = nil
		registerErr = errors.Join(registerErr, fmt.Errorf("%w: %s", greeterCGOMessageServerStreamPartiallyRegistered, "examples.grpc.greeter.v1.Greeter.Chat"))
	}
