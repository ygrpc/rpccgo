...
func (a *greeterCGOMessageAdapter) CollectStart(ctx context.Context) (rpcruntime.ClientStreamingClient[*v1.SayHelloRequest, *v1.SayHelloResponse], error) {
	if a == nil {
		return nil, greeterCGOMessageServerCallbacksNil
	}
...
func (a *greeterCGOMessageAdapter) BroadcastStart(ctx context.Context, req *v1.SayHelloRequest) (rpcruntime.ServerStreamingClient[*v1.SayHelloResponse], error) {
	if a == nil {
		return nil, greeterCGOMessageServerCallbacksNil
	}
...
func (a *greeterCGOMessageAdapter) ChatStart(ctx context.Context) (rpcruntime.BidiStreamingClient[*v1.SayHelloRequest, *v1.SayHelloResponse], error) {
	if a == nil {
		return nil, greeterCGOMessageServerCallbacksNil
	}
