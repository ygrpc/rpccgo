...
// rpccgoMsgGreeterv1GreeterBroadcastClose closes callback receive ownership for the message server-streaming client entrypoint for examples.grpc.greeter.v1.Greeter.Broadcast without delivering further callbacks.
//
...
// rpccgoMsgGreeterv1GreeterChatClose closes callback receive ownership for the message bidi-streaming client entrypoint for examples.grpc.greeter.v1.Greeter.Chat without delivering further callbacks.
//
