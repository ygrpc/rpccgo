...
func (a *greeterCGONativeAdapter) CollectStart(ctx context.Context) (rpcruntime.ClientStreamingClient[v1.GreeterCollectNativeStreamRequest, v1.GreeterCollectNativeStreamResponse], error) {
	if a == nil {
...
func (a *greeterCGONativeAdapter) BroadcastStart(ctx context.Context, name *rpcruntime.RpcString, city *rpcruntime.RpcString) (rpcruntime.ServerStreamingClient[v1.GreeterBroadcastNativeStreamResponse], error) {
	if a == nil {
		return nil, greeterCGONativeServerCallbacksNil
	}
...
func (a *greeterCGONativeAdapter) ChatStart(ctx context.Context) (rpcruntime.BidiStreamingClient[v1.GreeterChatNativeStreamRequest, v1.GreeterChatNativeStreamResponse], error) {
	if a == nil {
		return nil, greeterCGONativeServerCallbacksNil
	}
...
func (a *greeterCGONativeAdapter) Collect(ctx context.Context, stream v1.GreeterCollectNativeClientStream) (string, error) {
...
func (a *greeterCGONativeAdapter) Broadcast(ctx context.Context, name *rpcruntime.RpcString, city *rpcruntime.RpcString, stream v1.GreeterBroadcastNativeServerStream) error {
...
func (a *greeterCGONativeAdapter) Chat(ctx context.Context, stream v1.GreeterChatNativeBidiStream) error {
...
func decodeGreeterSayHelloCGONativeUnaryResponse(messagePtr C.uintptr_t, messageLen C.int32_t, messageOwnership C.int32_t) (string, error) {
	if _, err := rpcruntime.LengthFromInt32(int32(messageLen)); err != nil {
		return "", fmt.Errorf("examples.grpc.greeter.v1.SayHelloResponse.message: %w", err)
	}
...
func cleanupGreeterSayHelloCGONativeUnaryResponse(messagePtr C.uintptr_t, messageLen C.int32_t, messageOwnership C.int32_t) error {
	...
	if messageOwnership > 0 && messagePtr != 0 {
		if err := rpcruntime.ReleaseC(unsafe.Pointer(uintptr(messagePtr)), true, "examples.grpc.greeter.v1.SayHelloResponse.message"); err != nil {
