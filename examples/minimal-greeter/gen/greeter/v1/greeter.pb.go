...
const file_proto_greeter_proto_rawDesc = "" +
	"\n" +
	"\x13proto/greeter.proto\x12\x1bexamples.minimal.greeter.v1\"%\n" +
	"\x0fSayHelloRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\",\n" +
	"\x10SayHelloResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2r\n" +
	"\aGreeter\x12g\n" +
	"\bSayHello\x12,.examples.minimal.greeter.v1.SayHelloRequest\x1a-.examples.minimal.greeter.v1.SayHelloResponseB5Z3example.com/rpccgo-minimal/gen/greeter/v1;greeterv1b\x06proto3"
...
var file_proto_greeter_proto_goTypes = []any{
	(*SayHelloRequest)(nil),  // 0: examples.minimal.greeter.v1.SayHelloRequest
	(*SayHelloResponse)(nil), // 1: examples.minimal.greeter.v1.SayHelloResponse
}
var file_proto_greeter_proto_depIdxs = []int32{
	0, // 0: examples.minimal.greeter.v1.Greeter.SayHello:input_type -> examples.minimal.greeter.v1.SayHelloRequest
	1, // 1: examples.minimal.greeter.v1.Greeter.SayHello:output_type -> examples.minimal.greeter.v1.SayHelloResponse
