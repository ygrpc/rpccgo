...
const (
	...
	GreeterName = "examples.minimal.greeter.v1.Greeter"
)
...
const (
	...
	GreeterSayHelloProcedure = "/examples.minimal.greeter.v1.Greeter/SayHello"
)

// GreeterClient is a client for the examples.minimal.greeter.v1.Greeter service.
type GreeterClient interface {
	SayHello(context.Context, *SayHelloRequest) (*SayHelloResponse, error)
}

// NewGreeterClient constructs a client for the examples.minimal.greeter.v1.Greeter service. By
...
func NewGreeterClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) GreeterClient {
	...
	greeterMethods := File_proto_greeter_proto.Services().ByName("Greeter").Methods()
...
// SayHello calls examples.minimal.greeter.v1.Greeter.SayHello.
...
// GreeterHandler is an implementation of the examples.minimal.greeter.v1.Greeter service.
...
func NewGreeterHandler(svc GreeterHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/examples.minimal.greeter.v1.Greeter/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedGreeterHandler) SayHello(context.Context, *SayHelloRequest) (*SayHelloResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("examples.minimal.greeter.v1.Greeter.SayHello is not implemented"))
}
