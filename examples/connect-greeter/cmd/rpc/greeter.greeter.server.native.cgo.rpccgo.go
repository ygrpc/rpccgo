...
func (a *greeterCGONativeAdapter) Broadcast(ctx context.Context, name *rpcruntime.RpcString, city *rpcruntime.RpcString, stream proto.GreeterBroadcastNativeServerStream) error {
	...
	for {
		resp, err, stopped := greeterAwaitCGONativeRecv(ctx, stream.FinishRequested(), func() (proto.GreeterBroadcastNativeStreamResponse, error) { return session.Recv(ctx) }, finishSession, func() error { return session.Cancel(ctx) })
		if stopped {
			return err
		}
		if err != nil {
