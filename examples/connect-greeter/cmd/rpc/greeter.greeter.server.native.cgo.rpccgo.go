...
func (a *greeterCGONativeAdapter) CollectStart(ctx context.Context) (rpcruntime.ClientStreamingClient[proto.GreeterCollectNativeStreamRequest, proto.GreeterCollectNativeStreamResponse], error) {
	if a == nil {
...
func (s *greeterCollectCGONativeClientStreamingClient) Send(ctx context.Context, reqData proto.GreeterCollectNativeStreamRequest) error {
...
func (s *greeterCollectCGONativeClientStreamingClient) Finish(ctx context.Context) (proto.GreeterCollectNativeStreamResponse, error) {
	var outMessagePtr C.uintptr_t
	var outMessageLen C.int32_t
	var outMessageOwnership C.int32_t
	...
	if errID != 0 {
		...
		callbackErr := greeterCGONativeServerErrorFromID(errID)
		if cleanupErr != nil {
			return proto.GreeterCollectNativeStreamResponse{}, errors.Join(callbackErr, cleanupErr)
		}
		return proto.GreeterCollectNativeStreamResponse{}, callbackErr
	}
	messageResult, err := decodeGreeterCollectCGONativeClientStreamResponse(outMessagePtr, outMessageLen, outMessageOwnership)
	cleanupErr := cleanupGreeterCollectCGONativeClientStreamResponse(outMessagePtr, outMessageLen, outMessageOwnership)
	if cleanupErr != nil {
		if err != nil {
			return proto.GreeterCollectNativeStreamResponse{}, errors.Join(err, cleanupErr)
		}
		return proto.GreeterCollectNativeStreamResponse{}, cleanupErr
	}
	if err != nil {
		return proto.GreeterCollectNativeStreamResponse{}, err
	}
	return proto.GreeterCollectNativeStreamResponse{Message: messageResult}, nil
}
...
func (a *greeterCGONativeAdapter) BroadcastStart(ctx context.Context, name *rpcruntime.RpcString, city *rpcruntime.RpcString) (rpcruntime.ServerStreamingClient[proto.GreeterBroadcastNativeStreamResponse], error) {
	if a == nil {
		return nil, greeterCGONativeServerCallbacksNil
	}
...
func (s *greeterBroadcastCGONativeServerStreamingClient) Recv(ctx context.Context) (proto.GreeterBroadcastNativeStreamResponse, error) {
	var outMessagePtr C.uintptr_t
	var outMessageLen C.int32_t
	var outMessageOwnership C.int32_t
	...
	if errID != 0 {
		...
		callbackErr := greeterCGONativeServerErrorFromID(errID)
		if cleanupErr != nil {
			return proto.GreeterBroadcastNativeStreamResponse{}, errors.Join(callbackErr, cleanupErr)
		}
		return proto.GreeterBroadcastNativeStreamResponse{}, callbackErr
	}
	messageResult, err := decodeGreeterBroadcastCGONativeServerStreamResponse(outMessagePtr, outMessageLen, outMessageOwnership)
	cleanupErr := cleanupGreeterBroadcastCGONativeServerStreamResponse(outMessagePtr, outMessageLen, outMessageOwnership)
	if cleanupErr != nil {
		if err != nil {
			return proto.GreeterBroadcastNativeStreamResponse{}, errors.Join(err, cleanupErr)
		}
		return proto.GreeterBroadcastNativeStreamResponse{}, cleanupErr
	}
	if err != nil {
		return proto.GreeterBroadcastNativeStreamResponse{}, err
	}
	return proto.GreeterBroadcastNativeStreamResponse{Message: messageResult}, nil
}
...
func (a *greeterCGONativeAdapter) ChatStart(ctx context.Context) (rpcruntime.BidiStreamingClient[proto.GreeterChatNativeStreamRequest, proto.GreeterChatNativeStreamResponse], error) {
	if a == nil {
		return nil, greeterCGONativeServerCallbacksNil
	}
...
func (s *greeterChatCGONativeBidiStreamingClient) Send(ctx context.Context, reqData proto.GreeterChatNativeStreamRequest) error {
...
func (s *greeterChatCGONativeBidiStreamingClient) Recv(ctx context.Context) (proto.GreeterChatNativeStreamResponse, error) {
	var outMessagePtr C.uintptr_t
	var outMessageLen C.int32_t
	var outMessageOwnership C.int32_t
	...
	if errID != 0 {
		...
		callbackErr := greeterCGONativeServerErrorFromID(errID)
		if cleanupErr != nil {
			return proto.GreeterChatNativeStreamResponse{}, errors.Join(callbackErr, cleanupErr)
		}
		return proto.GreeterChatNativeStreamResponse{}, callbackErr
	}
	messageResult, err := decodeGreeterChatCGONativeBidiStreamResponse(outMessagePtr, outMessageLen, outMessageOwnership)
	cleanupErr := cleanupGreeterChatCGONativeBidiStreamResponse(outMessagePtr, outMessageLen, outMessageOwnership)
	if cleanupErr != nil {
		if err != nil {
			return proto.GreeterChatNativeStreamResponse{}, errors.Join(err, cleanupErr)
		}
		return proto.GreeterChatNativeStreamResponse{}, cleanupErr
	}
	if err != nil {
		return proto.GreeterChatNativeStreamResponse{}, err
	}
	return proto.GreeterChatNativeStreamResponse{Message: messageResult}, nil
}
...
func (a *greeterCGONativeAdapter) Collect(ctx context.Context, stream proto.GreeterCollectNativeClientStream) (string, error) {
	session, err := a.CollectStart(ctx)
	if err != nil {
		return "", err
	}
	for {
		...
		if err := session.Send(ctx, proto.GreeterCollectNativeStreamRequest{Name: name, City: city}); err != nil {
			_ = session.Cancel(ctx)
			return "", err
		}
	}
...
func (a *greeterCGONativeAdapter) Broadcast(ctx context.Context, name *rpcruntime.RpcString, city *rpcruntime.RpcString, stream proto.GreeterBroadcastNativeServerStream) error {
	session, err := a.BroadcastStart(ctx, name, city)
	if err != nil {
		return err
	}
	for {
		resp, err, stopped := greeterAwaitCGONativeRecv(ctx, stream.FinishRequested(), func() (proto.GreeterBroadcastNativeStreamResponse, error) { return session.Recv(ctx) }, func() error { return session.Finish(ctx) }, func() error { return session.Cancel(ctx) })
		if stopped {
			return err
		}
		if err != nil {
...
func (a *greeterCGONativeAdapter) Chat(ctx context.Context, stream proto.GreeterChatNativeBidiStream) error {
	...
	go func() {
		for {
			...
			if err := session.Send(ctx, proto.GreeterChatNativeStreamRequest{Name: name, City: city}); err != nil {
				sendDone <- err
				return
			}
		}
	...
	for {
		resp, err, stopped := greeterAwaitCGONativeRecv(ctx, stream.FinishRequested(), func() (proto.GreeterChatNativeStreamResponse, error) { return session.Recv(ctx) }, func() error { return session.Finish(ctx) }, func() error { return session.Cancel(ctx) })
		if stopped {
...
func rpccgoNativeGreeterv1GreeterRegister(sayHelloCallback C.GreeterSayHelloCGONativeUnaryCallback, collectStart C.GreeterCollectCGONativeClientStreamStartCallback, collectSend C.GreeterCollectCGONativeClientStreamSendCallback, collectFinish C.GreeterCollectCGONativeClientStreamFinishCallback, collectCancel C.GreeterCollectCGONativeClientStreamCancelCallback, broadcastStart C.GreeterBroadcastCGONativeServerStreamStartCallback, broadcastRecv C.GreeterBroadcastCGONativeServerStreamRecvCallback, broadcastFinish C.GreeterBroadcastCGONativeServerStreamFinishCallback, broadcastCancel C.GreeterBroadcastCGONativeServerStreamCancelCallback, chatStart C.GreeterChatCGONativeBidiStreamStartCallback, chatSend C.GreeterChatCGONativeBidiStreamSendCallback, chatRecv C.GreeterChatCGONativeBidiStreamRecvCallback, chatCloseSend C.GreeterChatCGONativeBidiStreamCloseSendCallback, chatFinish C.GreeterChatCGONativeBidiStreamFinishCallback, chatCancel C.GreeterChatCGONativeBidiStreamCancelCallback) C.int32_t {
	...
	if collectStart == nil && collectSend == nil && collectFinish == nil && collectCancel == nil {
		...
		registerErr = errors.Join(registerErr, fmt.Errorf("%w: %s", greeterCGONativeServerStreamPartiallyRegistered, "examples.connect.greeter.v1.Greeter.Collect"))
	}
	if broadcastStart == nil && broadcastRecv == nil && broadcastFinish == nil && broadcastCancel == nil {
		...
		registerErr = errors.Join(registerErr, fmt.Errorf("%w: %s", greeterCGONativeServerStreamPartiallyRegistered, "examples.connect.greeter.v1.Greeter.Broadcast"))
	}
	if chatStart == nil && chatSend == nil && chatRecv == nil && chatCloseSend == nil && chatFinish == nil && chatCancel == nil {
		...
		next.chatFinish = nil
		next.chatCancel = nil
		registerErr = errors.Join(registerErr, fmt.Errorf("%w: %s", greeterCGONativeServerStreamPartiallyRegistered, "examples.connect.greeter.v1.Greeter.Chat"))
	}
