...
func (a *greeterCGOMessageAdapter) StartCollect(ctx context.Context) (rpcruntime.CGOMessageClientStreamSession[*proto.SayHelloRequest, *proto.SayHelloResponse], error) {
	if a == nil {
		return nil, greeterCGOMessageServerCallbacksNil
	}
...
func (a *greeterCGOMessageAdapter) Collect(ctx context.Context, stream rpcruntime.CGOMessageClientStream[*proto.SayHelloRequest]) (*proto.SayHelloResponse, error) {
...
func (s *greeterCollectCGOMessageClientStreamSession) Send(ctx context.Context, req *proto.SayHelloRequest) error {
	if req == nil {
		err := errors.New("rpccgo: message request is nil")
		return err
	}
...
func (s *greeterCollectCGOMessageClientStreamSession) Finish(ctx context.Context) (*proto.SayHelloResponse, error) {
	var responsePtr C.uintptr_t
	var responseLen C.int32_t
...
func (a *greeterCGOMessageAdapter) StartBroadcast(ctx context.Context, req *proto.SayHelloRequest) (rpcruntime.CGOMessageServerStreamSession[*proto.SayHelloResponse], error) {
	if a == nil {
		return nil, greeterCGOMessageServerCallbacksNil
	}
...
func (a *greeterCGOMessageAdapter) Broadcast(ctx context.Context, req *proto.SayHelloRequest, stream rpcruntime.CGOMessageServerStream[*proto.SayHelloResponse]) error {
...
func (s *greeterBroadcastCGOMessageServerStreamSession) Recv(ctx context.Context) (*proto.SayHelloResponse, error) {
	var responsePtr C.uintptr_t
	var responseLen C.int32_t
...
func (a *greeterCGOMessageAdapter) StartChat(ctx context.Context) (rpcruntime.CGOMessageBidiStreamSession[*proto.SayHelloRequest, *proto.SayHelloResponse], error) {
	if a == nil {
		return nil, greeterCGOMessageServerCallbacksNil
	}
...
func (a *greeterCGOMessageAdapter) Chat(ctx context.Context, stream rpcruntime.CGOMessageBidiStream[*proto.SayHelloRequest, *proto.SayHelloResponse]) error {
...
func (s *greeterChatCGOMessageBidiStreamSession) Send(ctx context.Context, req *proto.SayHelloRequest) error {
	if req == nil {
		err := errors.New("rpccgo: message request is nil")
		return err
	}
...
func (s *greeterChatCGOMessageBidiStreamSession) Recv(ctx context.Context) (*proto.SayHelloResponse, error) {
	var responsePtr C.uintptr_t
	var responseLen C.int32_t
