...
func TestRenderNativeServerDefinesStreamingMethodSignatures(t *testing.T) {
	...
	for _, fragment := range []string{
		...
		"func startAllServiceGoNativeClientStream(ctx context.Context, server AllServiceNativeServer) (rpcruntime.ClientStreamingClient[AllServiceClientStreamNativeStreamRequest, AllServiceClientStreamNativeStreamResponse], error)",
		"func startAllServiceGoNativeServerStream(ctx context.Context, server AllServiceNativeServer, name *rpcruntime.RpcString, enabled bool, child *rpcruntime.RpcBytes) (rpcruntime.ServerStreamingClient[AllServiceServerStreamNativeStreamResponse], error)",
		"func startAllServiceGoNativeBidiStream(ctx context.Context, server AllServiceNativeServer) (rpcruntime.BidiStreamingClient[AllServiceBidiStreamNativeStreamRequest, AllServiceBidiStreamNativeStreamResponse], error)",
	...
	assertContentOrder(t, nativeServerContent,
		...
		"func SendAllServiceNativeClientStream(ctx context.Context, handle rpcruntime.StreamHandle",
	)
	assertGeneratedFileContentDoesNotContain(t, plugin, nativeServerFile,
