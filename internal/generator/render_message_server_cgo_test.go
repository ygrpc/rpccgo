...
func TestRenderMessageServerCGODefinesFlatServiceRegistration(t *testing.T) {
	...
	for _, fragment := range []string{
		...
		"func (a *greeterCGOMessageAdapter) UploadStart(ctx context.Context) (rpcruntime.ClientStreamingClient[*v1.HelloRequest, *v1.HelloReply], error) {",
		...
		"func (a *greeterCGOMessageAdapter) ListStart(ctx context.Context, req *v1.HelloRequest) (rpcruntime.ServerStreamingClient[*v1.HelloReply], error) {",
		...
		"func (a *greeterCGOMessageAdapter) ChatStart(ctx context.Context) (rpcruntime.BidiStreamingClient[*v1.HelloRequest, *v1.HelloReply], error) {",
		...
		"resp, err, stopped := greeterAwaitCGOMessageRecv(ctx, stream.FinishRequested(), func() (*v1.HelloReply, error) { return session.Recv(ctx) }, finishSession, func() error { return session.Cancel(ctx) })",
		...
		"//export rpccgoMsgTestv1GreeterRegisterUnary",
		"func rpccgoMsgTestv1GreeterRegisterUnary(unaryCallback C.GreeterUnaryCGOMessageUnaryCallback) C.int32_t {",
		"next := greeterCGOMessageServerAdapterForRegister()",
		"//export rpccgoMsgTestv1GreeterRegisterUpload",
		"if uploadStart == nil && uploadSend == nil && uploadFinish == nil && uploadCancel == nil {",
		`registerErr = errors.Join(registerErr, fmt.Errorf("%w: %s", greeterCGOMessageServerStreamPartiallyRegistered, "test.v1.Greeter.Upload"))`,
	...
	assertGeneratedFileContentDoesNotContain(t, plugin, cgoServerFile,
		"func decodeGreeterUnaryCGOMessageResponse(",
		"func decodeGreeterUploadCGOMessageResponse(",
		"func decodeGreeterListCGOMessageResponse(",
		"func decodeGreeterChatCGOMessageResponse(",
		"typedef struct GreeterCGOMessageServerCallbacks",
		"callbacks C.GreeterCGOMessageServerCallbacks",
		"rpccgoMsgTestv1GreeterUnaryRegister",
