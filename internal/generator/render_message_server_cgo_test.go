...
func TestRenderMessageServerCGODefinesFlatServiceRegistration(t *testing.T) {
	...
	for _, fragment := range []string{
		...
		"func (a *greeterCGOMessageAdapter) StartUpload(ctx context.Context) (rpcruntime.CGOMessageClientStreamSession[*v1.HelloRequest, *v1.HelloReply], error) {",
		"func (a *greeterCGOMessageAdapter) Upload(ctx context.Context, stream rpcruntime.CGOMessageClientStream[*v1.HelloRequest]) (*v1.HelloReply, error) {",
		"func (a *greeterCGOMessageAdapter) StartList(ctx context.Context, req *v1.HelloRequest) (rpcruntime.CGOMessageServerStreamSession[*v1.HelloReply], error) {",
		"func (a *greeterCGOMessageAdapter) List(ctx context.Context, req *v1.HelloRequest, stream rpcruntime.CGOMessageServerStream[*v1.HelloReply]) error {",
		"func (a *greeterCGOMessageAdapter) StartChat(ctx context.Context) (rpcruntime.CGOMessageBidiStreamSession[*v1.HelloRequest, *v1.HelloReply], error) {",
		"func (a *greeterCGOMessageAdapter) Chat(ctx context.Context, stream rpcruntime.CGOMessageBidiStream[*v1.HelloRequest, *v1.HelloReply]) error {",
