...
func TestRenderNativeServerCGODefinesPerMethodCallbackRegistration(t *testing.T) {
	...
	for _, fragment := range []string{
		...
		"PayloadWrapper := rpcruntime.NewRpcBytes((*byte)(unsafe.Pointer(uintptr(output.PayloadPtr))), int32(output.PayloadLen), false)",
		"payloadResult := PayloadWrapper.SafeBytes()",
		"func cleanupAllServiceUnaryCGONativeUnaryResponse(output *AllServiceUnaryCGONativeUnaryResponse) error {",
...
func TestRenderNativeServerCGOSupportsRepeatedNativeABI(t *testing.T) {
	...
	for _, fragment := range []string{
		...
		"ScoresPtr       C.uintptr_t",
		"ScoresLen       C.int32_t",
		"ScoresOwnership C.int32_t",
		"FlagsPtr        C.uintptr_t",
		"FlagsLen        C.int32_t",
		"FlagsOwnership  C.int32_t",
		"CountsPtr       C.uintptr_t",
		"CountsLen       C.int32_t",
		"CountsOwnership C.int32_t",
		"RatiosPtr       C.uintptr_t",
		"RatiosLen       C.int32_t",
		"RatiosOwnership C.int32_t",
		"MoodsPtr        C.uintptr_t",
		"MoodsLen        C.int32_t",
		"MoodsOwnership  C.int32_t",
		"rpcruntime.NewRpcRepeatChecked((*int32)(unsafe.Pointer(uintptr(output.ScoresPtr))), int32(output.ScoresLen), false)",
		"rpcruntime.NewRpcRepeatChecked((*int64)(unsafe.Pointer(uintptr(output.CountsPtr))), int32(output.CountsLen), false)",
