...
func TestRenderNativeServerCGODefinesFlatServiceCallbackRegistration(t *testing.T) {
	...
	for _, fragment := range []string{
		...
		"//export rpccgo_native_testv1_AllService_register_Unary",
		"func rpccgo_native_testv1_AllService_register_Unary(unaryCallback C.AllServiceUnaryCGONativeUnaryCallback) C.int32_t {",
		"next := allServiceCGONativeServerAdapterForRegister()",
		"//export rpccgo_native_testv1_AllService_register_ClientStream",
