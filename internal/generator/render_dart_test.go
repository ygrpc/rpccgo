...
func TestGenerateDartEmitsStreamingMessageFFIClient(t *testing.T) {
	...
	for _, fragment := range []string{
		...
		"class GreeterRpccgoMessageServer {",
		"String? RegisterUpload(({GreeterUploadMessageServerHandler? value, String? error}) Function() start) {",
		"abstract interface class GreeterUploadMessageServerHandler {",
		"String? Send(pb.MessageRequest request);",
		"({pb.MessageReply? value, String? error}) Finish();",
		"String? RegisterList(({GreeterListMessageServerHandler? value, String? error}) Function(pb.MessageRequest request) start) {",
		"abstract interface class GreeterListMessageServerHandler {",
		"({pb.MessageReply? value, String? error}) Recv();",
		"String? RegisterChat(({GreeterChatMessageServerHandler? value, String? error}) Function() start) {",
		"abstract interface class GreeterChatMessageServerHandler {",
		"String? CloseSend();",
		"@ffi.Native<_RpccgoRegisterClientStreamingServerCAbi>(symbol: 'rpccgoMsgTestv1GreeterRegisterUpload')",
		"@ffi.Native<_RpccgoRegisterServerStreamingServerCAbi>(symbol: 'rpccgoMsgTestv1GreeterRegisterList')",
		"@ffi.Native<_RpccgoRegisterBidiStreamingServerCAbi>(symbol: 'rpccgoMsgTestv1GreeterRegisterChat')",
		"ffi.NativeCallable<_RpccgoMessageServerStartCAbi>.isolateLocal",
		"ffi.NativeCallable<_RpccgoMessageServerSendCAbi>.isolateLocal",
		"ffi.NativeCallable<_RpccgoMessageServerRecvCAbi>.isolateLocal",
		"exceptionalReturn: -1",
	} {
