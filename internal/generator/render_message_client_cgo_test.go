...
func TestRenderMessageClientCGODefinesUnaryExportSurface(t *testing.T) {
	...
	for _, fragment := range []string{
		...
		"func rpccgoMsgTestv1GreeterListStart(requestPtr C.uintptr_t, requestLen C.int32_t, handle *C.int32_t) C.int32_t {",
		"//export rpccgoMsgTestv1GreeterListRead",
		"func rpccgoMsgTestv1GreeterListRead(handle C.int32_t, responsePtr *C.uintptr_t, responseLen *C.int32_t) C.int32_t {",
